...
export const Models = () => {
  ...
  // Get visible cards
  const visibleCards = screenSize === 'mobile' 
    ? [modelsData[currentIndex]]
    : modelsData;

  return (
<section className="w-full flex justify-center px-relaxed py-relaxed bg-white">
  <div className="relative isolate w-full max-w-[1248px] md:h-[744px] flex items-end">
    ...
    <div className="relative z-10 w-full flex flex-col gap-6 pb-8">
      ...
      <div className="max-w-[592px] flex flex-col gap-2">
        <HighlightedHeading text="Partnership Models" className="font-heading" />
      ...
      {screenSize === 'mobile' && (
        <div className="flex items-center justify-center gap-4 mt-4">
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 18L15 12L9 6" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </div>
      )}
